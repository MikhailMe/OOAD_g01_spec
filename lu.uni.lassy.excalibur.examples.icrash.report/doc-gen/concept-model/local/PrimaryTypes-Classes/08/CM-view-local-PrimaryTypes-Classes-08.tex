Figure \ref{fig:lu.uni.lassy.excalibur.examples.icrash-CM-view-local-PrimaryTypes-Classes-08} 
...
\includegraphics[
angle=0
]{./images-report-gen/concept-model/local/PrimaryTypes-Classes/08/em-gv-01.eps}
\end{center}
