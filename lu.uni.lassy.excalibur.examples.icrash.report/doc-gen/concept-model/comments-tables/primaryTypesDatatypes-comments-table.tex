...
\adddoublerow{dtAnswer}{a string, which contain answer on the additional question for administrator to authentify}
\addsingletwocolumnrow{extends}{dtEncryptable}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which strings are considered as valid dtAnswer}
...
\adddoublerow{dtEncryptable}{}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{decrypt(AKey:dtKey):ptBoolean}}{used for decrypting the called object }
\adddoubletwocolumnrow{operation}{\msrcode{encrypt(AKey:dtKey):ptBoolean}}{used for encrypting the called object }
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used for checked isEncrypted}
...
\adddoublerow{dtKey}{a string, which contains special secret key, which store in the secret file}
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to encrypt and decrypt login and password or login and answer}
...
\adddoublerow{dtQuestion}{a string, which contain additional question for administrator to authentify }
\addsingletwocolumnrow{extends}{dtEncryptable}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used for the user to see the actual question}
\end{datadictionary}
